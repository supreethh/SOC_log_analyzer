...
**Log Source:** Custom application logs generated by a test application
...
Upon threshold breach, the analyzer generates a console-based alert indicating suspected brute-force activity.
